...
public class StartHereApplication
{
    ...
    private static void checkEnvironmentVariable(String envvar) // checking to see if enviroment variable exist
    {
    ...
    public static void main(String[] args) // if we don't find the variables then stop the appilcation
    {
